							...
							<table id="example2" class="table card-table display dataTablesCard">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<a href="{{ route('customer.edit', $user->id) }}" class="btn btn-primary btn-sm" style="margin-right: 5px;">{{ __('Edit') }}</a>
											<a href="{{ route('customer.info', $user->id) }}" class="btn btn-primary btn-sm" style="margin-right: 5px;">{{ __('Detail') }}</a>
