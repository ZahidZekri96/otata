            ...
            <div class="col-xl-10 m-auto">
                <div class="card event-detail-bx overflow-hidden">
                    ...
                    <div class="d-flex flex-wrap align-items-center mb-4">
                        ...
                        <button class="btn btn-primary mr-3"><i class="fa fa-users mr-3 scale5" aria-hidden="true"></i>Subscription Event</button>
                        <div class="dropdown">
                    ...
                    <div class="row">
                        ...
                        <div class="media bg-light p-3 rounded align-items-center">	
                            ...
                            <span class="fs-16 text-black">Everyday</span>
                            </div>
                        </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-xxl-6 mb-3">
                        <div class="media bg-light p-3 rounded align-items-center">	
                            ...
                            <div class="media-body">
                            <span class="fs-12 d-block mb-1">Time</span>
                            <span class="fs-16 text-black">{{date("h:i A", strtotime($getEvent->event_time)) }}</span>
                            </div>
                        </div>
                        </div>
